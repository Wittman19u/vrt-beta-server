...
function getActivities(req, res, next){
    ...
    let sql = `SELECT * FROM buffer where st_contains(ST_GeomFromText('POLYGON(${req.query.west} ${req.query.north}, ${req.query.east} ${req.query.north}, ${req.query.east} ${req.query.south}, ${req.query.west} ${req.query.south}, ${req.query.west} ${req.query.north}, ), geom)`;
